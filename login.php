          ...
          if (mysqli_stmt_fetch($stmt)) {
            ...
            if (password_verify($user_password, $hashed_password)) {
              ...
              $_SESSION["loggedin"] = TRUE;
                ...
                if($username == 'InQKA_UiTM') { // admin user
                    echo "<script>" . "window.location.href='./query.php'" . "</script>";
                } else { // public user
                    echo "<script>" . "window.location.href='./new-query.php'" . "</script>";
                }
              exit;
            } else {
...
<head>
  ...
  <title>PAI'S InQKA UiTM System</title>
...
<style>
  .container {
    background-image: url('img/uitmbg.png');
  ...
  <div class="container">
    <div class="row min-vh-100 justify-content-center align-items-center" >
      <div class="col-lg-5">
        ...
        ?>
        <div class="form-wrap border rounded p-4" style="background-color: white; opacity: 90%;">
          <h1>Log In</h1>
