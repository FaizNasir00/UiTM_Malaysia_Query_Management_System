...
<ul class="navbar-nav bg-gradient-gray sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <!-- Sidebar - Brand -->
    <!-- Sidebar - Brand -->
    <a class="sidebar-brand d-flex align-items-center justify-content-center" href="query.php">
    ...
    <li class="nav-item">
        ...
        <div id="collapseMenu" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item" href="query.php">Manage Query</a>
                <a class="collapse-item" href="places.php">Manage Location</a>
