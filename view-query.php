<?php 
    ...
    $sql = "SELECT * FROM query 
        ...
        WHERE query.user = $userId";
    
    while ($row = mysqli_fetch_assoc($result)) {
    echo $row['user']; // Assuming 'user' is the column name from the 'query' table
    }
...
<body id="page-top">
                                                ...
                                                <tr>   
                                                    ...
                                                    <td>
                                                         ...
                                                         <div class="d-flex align-items-center">
                                                            ...
                                                            <a class="btn btn-dark  btnIcon py-2-5 ml-2" href="user-edit-query.php?eid=<?php echo $rows['id'] ?>" data-bs-toggle="tooltip" data-bs-placement="top" title="Edit"><i class="fas fa-pen"></i></a>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            $('a[href="view-query.php"]').addClass('active');
