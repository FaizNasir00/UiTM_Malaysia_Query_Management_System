...
<body id="page-top">
                                                ...
                                                <tr>   
                                                    ...
                                                    <td>
                                                         ...
                                                         <div class="d-flex align-items-center">
                                                             ...
                                                             <form method="POST" action="view-user.php" onsubmit="javascript:return confirm('Confirm to delete user?')">

                                                             <input value="<?php echo $rows['user_id'] ?>" name="sid" type="hidden" />
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            $('a[href="view-user.php"]').addClass('active');
