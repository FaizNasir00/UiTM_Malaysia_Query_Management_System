                        ...
                        <div class="col-12 col-md-10 mb-4">
                            <div class="card shadow h-100 pb-2">
                                <div class="card-header d-flex align-items-center justify-content-between">
                                    <h6 class="text-uppercase mb-0">New Query</h6>
                                </div>
                                <div class="card-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-12 col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <?php
                                                        $result = mysqli_query($conn, "SELECT query_id FROM query ORDER BY query_id DESC LIMIT 1");
                                                        if ($result && mysqli_num_rows($result) > 0) {
                                                            $lastId = mysqli_fetch_row($result)[0]; 
                                                            $numPart = substr($lastId, 2);
                                                            $intPart = intval($numPart);
                                                            $nextIntPart = $intPart + 1;
                                                            $nextId = "QU" . str_pad($nextIntPart, 3, "0", STR_PAD_LEFT); 
                                                        } else {
                                                            $nextId = "QU000";
                                                        }
                                                    ?>
                                                    <input type="text" class="form-control" id="id" placeholder="Query ID" name="id" value="<?php echo $nextId; ?>" required readonly>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-12 col-md-5">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" id="place" name="place" required>
                                                        ...
                                                        ?>
                                                            <option value="<?php echo $rowK['location_id'] ?>"><?php echo $rowK['location_name'] ?></option>
                                                        <?php
                                                            }
                                                        } ?>
                                                    </select>
                                            ...
                                            <div class="col-12 col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="form-control" id="soalan" placeholder="Soalan" name="soalan" required rows="10"></textarea>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="text-center mt-3">
                                            <button type="submit" name="create-query" class="btn btn-dark">Save Query</button>
                                        </div>
                                    </form>
